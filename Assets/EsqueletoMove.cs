  ...
  //public GameObject player;
    ...
    void Update () 
    {
       if(direction.x < 0) {
          ...
          collvisao.offset = new Vector2 (-0.68f , 0f);
    ...
    void FixedUpdate()
    {
      ...
      Esqueleto.transform.position += direction * Time.deltaTime * speed;  
    }
    ...
    IEnumerator KillEnemy()
    {
      ...
      coll.enabled = false;
      Esqueleto.GetComponent<Rigidbody2D>().isKinematic = true;
      //coll.isTrigger = true;
